...
export class RewardDistributor_v1__computeRewardsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class RewardDistributor_v1 extends ethereum.SmartContract {
  static bind(address: Address): RewardDistributor_v1 {
    return new RewardDistributor_v1("RewardDistributor_v1", address);
  }
  ...
  claim1(addr: Address, restake: boolean): BigInt {
  ...
  try_claim1(addr: Address, restake: boolean): ethereum.CallResult<BigInt> {
  ...
  computeRewards(addr: Address): RewardDistributor_v1__computeRewardsResult {
    let result = super.call(
      "computeRewards",
    ...
    return new RewardDistributor_v1__computeRewardsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_computeRewards(
    addr: Address
  ): ethereum.CallResult<RewardDistributor_v1__computeRewardsResult> {
    let result = super.tryCall(
      "computeRewards",
      "computeRewards(address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(addr)]
    ...
    return ethereum.CallResult.fromValue(
      new RewardDistributor_v1__computeRewardsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
